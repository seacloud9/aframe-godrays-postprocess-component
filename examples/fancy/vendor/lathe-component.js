...
// index.js
    ...
    var extrudeComponent = {
        ...
        update: function(oldData) {
            ...
            this.el.object3D.mesh = geo;
        },

        remove: function() {}
    };

    AFRAME.registerComponent('extrude', extrudeComponent);
    AFRAME.registerComponent('lathe',   latheComponent);
})();